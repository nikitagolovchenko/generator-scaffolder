...
const { PROMPTS_VALUES, PATHS, OTHER_FILES, SCRIPTS, PACKAGES } = require(`${process.cwd()}/generators/app/globals`);
  ...
  describe('Generating files:', () => {
    it(chalk.green('Create expected files'), async () => {
      ...
      const expectedFiles = [...await getFilesArray(PATHS.baseFolder)]
        .concat([...await getFilesArray(join(PATHS.templatesFolder, 'bootstrap'))])
