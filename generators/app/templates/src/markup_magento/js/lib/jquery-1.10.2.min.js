...
(function(e, t) {
  ...
  (x.fn = x.prototype = {
    ...
    (x.extend = x.fn.extend = function() {
      ...
      let c = !1;
      for (
        typeof s === 'boolean' && ((c = s), (s = arguments[1] || {}), (l = 2)),
    ...
    x.extend({
      ...
      merge(e, n) {
        ...
        let o = 0;
        if (typeof r === 'number') for (; r > o; o++) e[i++] = n[o];
      ...
      map(e, t, n) {
        ...
        const s = [];
        if (a) for (; o > i; i++) (r = t(e[i], i, n)), r != null && (s[s.length] = r);
        else for (i in e) (r = t(e[i], i, n)), r != null && (s[s.length] = r);
        return d.apply([], s);
      },
      guid: 1,
      proxy(e, n) {
    ...
    (x.ready.promise = function(t) {
      if (!n)
        if (((n = x.Deferred()), a.readyState === 'complete')) setTimeout(x.ready);
        else if (a.addEventListener) a.addEventListener('DOMContentLoaded', q, !1), e.addEventListener('load', q, !1);
        else {
          a.attachEvent('onreadystatechange', q), e.attachEvent('onload', q);
          let r = !1;
          try {
            r = e.frameElement == null && a.documentElement;
          } catch (i) {}
          r &&
            r.doScroll &&
            (function o() {
  ...
  function M(e) {
    ...
    return x.isWindow(e)
      ...
      : e.nodeType === 1 && t
        ? !0
        : n === 'array' || (n !== 'function' && (t === 0 || (typeof t === 'number' && t > 0 && t - 1 in e)));
  }
  (r = x(a)),
    (function(e, t) {
      let n;
      ...
      function at(e, t, n, i) {
        ...
        let y;
        let x;
        if (((t ? t.ownerDocument || t : w) !== f && p(t), (t = t || f), (n = n || []), !e || typeof e !== 'string'))
          return n;
      ...
      function pt(e, t) {
        ...
        const r = n && e.nodeType === 1 && t.nodeType === 1 && (~t.sourceIndex || D) - (~e.sourceIndex || D);
        if (r) return r;
          ...
          return n !== f && n.nodeType === 9 && n.documentElement
            ? ((f = n),
              ...
              i &&
                i.attachEvent &&
                i !== i.top &&
                i.attachEvent('onbeforeunload', () => {
                  p();
                }),
              (r.attributes = ut(e => (e.className = 'i'), !e.getAttribute('className'))),
              (r.getElementsByTagName = ut(
                e => e.appendChild(n.createComment('')),
                !e.getElementsByTagName('*').length
              )),
              (r.getElementsByClassName = ut(
                e => (
                ...
                : function(t, n, l) {
                    ...
                    if (m) {
                      if (o) {
                        while (g) {
                          p = t;
                          while ((p = p[g])) if (s ? p.nodeName.toLowerCase() === y : p.nodeType === 1) return !1;
      ...
      function vt(e, t, n) {
        ...
        return t.first
          ...
          : function(t, n, s) {
              ...
              const p = `${T} ${a}`;
              if (s) {
                while ((t = t[r])) if ((t.nodeType === 1 || o) && e(t, n, s)) return !0;
              } else
                while ((t = t[r]))
                  if (t.nodeType === 1 || o)
      ...
      function Ct(e, t) {
        ...
        const s = function(s, l, c, p, d) {
          ...
          const k = (T += C == null ? 1 : Math.random() || 0.1);
      ...
      function kt(e, t, n, i) {
        ...
        if (!i && f.length === 1) {
          if (
            ((s = f[0] = f[0].slice(0)),
            s.length > 2 && (u = s[0]).type === 'ID' && r.getById && t.nodeType === 9 && h && o.relative[s[1].type])
          ) {
      ...
      (r.sortStable =
        ...
        ut(e => (e.innerHTML = "<a href='#'></a>"), e.firstChild.getAttribute('href') === '#') ||
          ct('type|href|height|width', (e, n, r) => (r ? t : e.getAttribute(n, n.toLowerCase() === 'type' ? 1 : 2))),
        (r.attributes &&
          ut(
            e => (
              (e.innerHTML = '<input/>'),
          ...
          ct('value', (e, n, r) => (r || e.nodeName.toLowerCase() !== 'input' ? t : e.defaultValue)),
        ut(e => e.getAttribute('disabled') == null) ||
          ct(B, (e, n, r) => {
            let i;
  ...
  (x.Callbacks = function(e) {
    ...
    (x.support = (function(t) {
      ...
      (s = a.createElement('select')),
        ...
        (t.html5Clone = a.createElement('nav').cloneNode(!0).outerHTML !== '<:nav></:nav>'),
      ...
      return (
        ...
        x(() => {
          ...
          l &&
            ...
            (p = o[0].offsetHeight === 0),
            (o[0].style.display = ''),
            (o[1].style.display = 'none'),
            (t.reliableHiddenOffsets = p && o[0].offsetHeight === 0),
            (d.innerHTML = ''),
            (d.style.cssText =
              'box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;'),
            x.swap(l, l.style.zoom != null ? { zoom: 1 } : {}, () => {
  ...
  function R(e, n, r, i) {
    if (x.acceptData(e)) {
      ...
      let c = l ? e[s] : e[s] && s;
      if ((c && u[c] && (i || u[c].data)) || r !== t || typeof n !== 'string')
        return (
          ...
          typeof n === 'string' ? ((o = a[n]), o == null && (o = a[x.camelCase(n)])) : (o = a),
          o
        );
    }
  }
  ...
  function $(e, n, r) {
    if (r === t && e.nodeType === 1) {
      ...
      if (((r = e.getAttribute(i)), typeof r === 'string')) {
        try {
          r =
            r === 'true'
              ? !0
  ...
  function I(e) {
    let t;
    for (t in e) if ((t !== 'data' || !x.isEmptyObject(e[t])) && t !== 'toJSON') return !1;
    return !0;
  }
  x.extend({
    queue(e, n, r) {
  ...
  x.fn.extend({
    ...
    addClass(e) {
      ...
      if (l)
        for (t = (e || '').match(T) || []; s > a; a++)
          if (((n = this[a]), (r = n.nodeType === 1 && (n.className ? ` ${n.className} `.replace(U, ' ') : ' ')))) {
            o = 0;
    ...
    removeClass(e) {
      ...
      const l = arguments.length === 0 || (typeof e === 'string' && e);
      if (x.isFunction(e))
        return this.each(function(t) {
    ...
    hasClass(e) {
      ...
      const r = this.length;
      for (; r > n; n++)
        if (this[n].nodeType === 1 && ` ${this[n].className} `.replace(U, ' ').indexOf(t) >= 0) return !0;
      return !1;
    },
    val(e) {
      let n;
            ...
            this.each(function(n) {
              ...
              this.nodeType === 1 &&
                ...
                o == null
                  ...
                  : typeof o === 'number'
                    ? (o += '')
                    : x.isArray(o) && (o = x.map(o, e => (e == null ? '' : `${e}`))),
        ...
        if (o)
          return (
            ...
            r && 'get' in r && (n = r.get(o, 'value')) !== t
              ? n
              : ((n = o.value), typeof n === 'string' ? n.replace(V, '') : n == null ? '' : n)
          );
      }
    }
  }),
          ...
          get(e) {
            ...
            for (; s > l; l++)
              if (
                ...
                !(
                  (!n.selected && l !== i) ||
                  (x.support.optDisabled ? n.disabled : n.getAttribute('disabled') !== null) ||
        ...
        if (e && s !== 3 && s !== 8 && s !== 2)
          return typeof e.getAttribute === i
            ...
            : ((s === 1 && x.isXMLDoc(e)) ||
              ...
              r === t
                ? o && 'get' in o && (a = o.get(e, n)) !== null
                  ? a
                  : ((a = x.find.attr(e, n)), a == null ? t : a)
                : r !== null
  ...
  (x.event = {
    ...
    handlers(e, n) {
      ...
      let u = e.target;
      if (l && u.nodeType && (!e.button || e.type !== 'click'))
    ...
    simulate(e, t, n, r) {
      const i = x.extend(new x.Event(), n, { type: e, isSimulated: !0, originalEvent: {} });
      ...
      (x.event.special.submit = {
        setup() {
          return x.nodeName(this, 'form')
            ? !1
            : (x.event.add(this, 'click._submit keypress._submit', e => {
                const n = e.target;

                const r = x.nodeName(n, 'input') || x.nodeName(n, 'button') ? n.form : t;
                r &&
                  !x._data(r, 'submitBubbles') &&
                  (x.event.add(r, 'submit._submit', e => {
                    e._submit_bubble = !0;
                  }),
    ...
    x.support.changeBubbles ||
      (x.event.special.change = {
        setup() {
          return Z.test(this.nodeName)
            ? ((this.type === 'checkbox' || this.type === 'radio') &&
              ...
              !1)
            : (x.event.add(this, 'beforeactivate._change', e => {
                const t = e.target;
                Z.test(t.nodeName) &&
        ...
        handle(e) {
          const n = e.target;
          return this !== n || e.isSimulated || e.isTrigger || (n.type !== 'radio' && n.type !== 'checkbox')
    ...
    x.support.focusinBubbles ||
      x.each({ focus: 'focusin', blur: 'focusout' }, (e, t) => {
        let n = 0;
  ...
  const ct = { children: !0, contents: !0, next: !0, prev: !0 };
  x.fn.extend({
    find(e) {
      let t;
    ...
    closest(e, t) {
      ...
      const a = ut.test(e) || typeof e !== 'string' ? x(e, t || this.context) : 0;
      for (; i > r; r++)
    ...
    add(e, t) {
      const n = typeof e === 'string' ? x(e, t) : x.makeArray(e && e.nodeType ? [e] : e);
        ...
        return (
          ...
          t.length === 1 && r.nodeType === 1
            ? x.find.matchesSelector(r, e)
              ? [r]
              : []
            : x.find.matches(e, x.grep(t, e => e.nodeType === 1))
        );
      },
      dir(e, n, r) {
        const i = [];
  ...
  function ft(e, t, n) {
    if (x.isFunction(t)) return x.grep(e, (e, r) => !!t.call(e, r, e) !== n);
    if (t.nodeType) return x.grep(e, e => (e === t) !== n);
    if (typeof t === 'string') {
  ...
  (At.optgroup = At.option),
    ...
    x.fn.extend({
      ...
      remove(e, t) {
        ...
        let i = 0;
        for (; (n = r[i]) != null; i++)
          t || n.nodeType !== 1 || x.cleanData(Ft(n)),
        ...
        return x.access(
          ...
          function(e) {
            ...
            if (
              ...
              e = e.replace(vt, '<$1></$2>');
              try {
                for (; i > r; r++) (n = this[r] || {}), n.nodeType === 1 && (x.cleanData(Ft(n, !1)), (n.innerHTML = e));
                n = 0;
              } catch (o) {}
            }
      ...
      replaceWith() {
        const e = x.map(this, e => [e.nextSibling, e.parentNode]);
      ...
      domManip(e, t, n) {
        ...
        if (g || (!(c <= 1 || typeof h !== 'string' || x.support.checkClone) && Nt.test(h)))
  ...
  function Lt(e, t) {
    return x.nodeName(e, 'table') && x.nodeName(t.nodeType === 1 ? t : t.firstChild, 'tr')
      ? e.getElementsByTagName('tbody')[0] || e.appendChild(e.ownerDocument.createElement('tbody'))
      : e;
  }
  function Ht(e) {
    return (e.type = `${x.find.attr(e, 'type') !== null}/${e.type}`), e;
  }
  function qt(e) {
  ...
  function _t(e, t) {
    ...
    let r = 0;
    for (; (n = e[r]) != null; r++) x._data(n, 'globalEval', !t || x._data(t[r], 'globalEval'));
  }
  function Mt(e, t) {
  ...
  x.extend({
    clone(e, t, n) {
      ...
      if (
        ...
        for (r = Ft(o), s = Ft(e), a = 0; (i = s[a]) != null; ++a) r[a] && Ot(i, r[a]);
      if (t)
        if (n) for (s = s || Ft(e), r = r || Ft(o), a = 0; (i = s[a]) != null; a++) Mt(i, r[a]);
        else Mt(e, o);
    ...
    buildFragment(e, t, n, r) {
      ...
      for (; p > h; h++)
        if (((o = e[h]), o || o === 0))
          if (x.type(o) === 'object') x.merge(d, o.nodeType ? [o] : o);
          else if (wt.test(o)) {
            ...
            if (
              ...
              (o = l !== 'table' || xt.test(o) ? (c[1] !== '<table>' || xt.test(o) ? 0 : s) : s.firstChild),
    ...
    x.fn.extend({
      wrapAll(e) {
        ...
        if (this[0]) {
          const t = x(e, this[0].ownerDocument)
            .eq(0)
            .clone(!0);
  ...
  const Qt = { position: 'absolute', visibility: 'hidden', display: 'block' };
    ...
    for (; s > a; a++)
      (r = e[a]),
        r.style &&
          ...
          (n = r.style.display),
          t
            ? (o[a] || n !== 'none' || (r.style.display = ''),
              r.style.display === '' && nn(r) && (o[a] = x._data(r, 'olddisplay', ln(r.nodeName))))
            : o[a] ||
              ((i = nn(r)), ((n && n !== 'none') || !i) && x._data(r, 'olddisplay', i ? n : x.css(r, 'display'))));
    for (a = 0; s > a; a++)
      (r = e[a]),
        r.style &&
          ((t && r.style.display !== 'none' && r.style.display !== '') || (r.style.display = t ? o[a] || '' : 'none'));
    return e;
  }
  x.fn.extend({
    css(e, n) {
    ...
    x.extend({
      ...
      style(e, n, r, i) {
        if (e && e.nodeType !== 3 && e.nodeType !== 8 && e.style) {
          ...
          if (
            ((a = typeof r),
            a === 'string' && (o = Jt.exec(r)) && ((r = (o[1] + 1) * o[2] + parseFloat(x.css(e, n))), (a = 'number')),
            !(
              r == null ||
              (a === 'number' && isNaN(r)) ||
              (a !== 'number' || x.cssNumber[l] || (r += 'px'),
              x.support.clearCloneStyle || r !== '' || n.indexOf('background') !== 0 || (u[n] = 'inherit'),
  ...
  function an(e, t, n, r, i) {
    ...
    let a = 0;
    for (; o < 4; o += 2)
      n === 'margin' && (a += x.css(e, n + Zt[o], !0, i)),
        r
          ? (n === 'content' && (a -= x.css(e, `padding${Zt[o]}`, !0, i)),
            n !== 'margin' && (a -= x.css(e, `border${Zt[o]}Width`, !0, i)))
          : ((a += x.css(e, `padding${Zt[o]}`, !0, i)),
            n !== 'padding' && (a += x.css(e, `border${Zt[o]}Width`, !0, i)));
    return a;
  }
  function sn(e, t, n) {
    let r = !0;
    ...
    const a = x.support.boxSizing && x.css(e, 'boxSizing', !1, o) === 'border-box';
    if (i <= 0 || i == null) {
    ...
    x.expr &&
      ...
      ((x.expr.filters.hidden = function(e) {
        return (
          ...
          (!x.support.reliableHiddenOffsets && ((e.style && e.style.display) || x.css(e, 'display')) === 'none')
        );
      }),
    ...
    x.each({ margin: '', padding: '', border: 'Width' }, (e, t) => {
      (x.cssHooks[e + t] = {
        expand(n) {
          ...
          for (; r < 4; r++) i[e + Zt[r] + t] = o[r] || o[r - 2] || o[0];
          return i;
        }
      }),
      ...
      return this.map(function() {
        ...
        .map(function(e, t) {
          ...
          return n == null
            ? null
            : x.isArray(n)
              ? x.map(n, e => ({ name: t.name, value: e.replace(fn, '\r\n') }))
  ...
  (x.fn.load = function(e, n, r) {
    ...
    return (
      ...
      x.isFunction(n) ? ((r = n), (n = t)) : n && typeof n === 'object' && (a = 'POST'),
      s.length > 0 &&
        x
        ...
        if (
          ...
          p.crossDomain == null &&
            ...
            (p.crossDomain = !(
              ...
              (r[1] === mn[1] &&
                r[2] === mn[2] &&
                (r[3] || (r[1] === 'http:' ? '80' : '443')) === (mn[3] || (mn[1] === 'http:' ? '80' : '443')))
            ))),
          p.data && p.processData && typeof p.data !== 'string' && (p.data = x.param(p.data, p.traditional)),
          qn(An, p, n, C),
          b === 2)
        )
          return C;
        (l = p.global),
          l && x.active++ === 0 && x.event.trigger('ajaxStart'),
                    ...
                    if (r && (i || l.readyState === 4))
                      if (((r = t), a && ((l.onreadystatechange = x.noop), $n && delete Pn[a]), i))
                        ...
                        (p = {}),
                          ...
                          typeof l.responseText === 'string' && (p.text = l.responseText);
                        try {
                          c = l.statusText;
                        } catch (f) {
                          c = '';
  ...
  const Qn = {
    '*': [
      function(e, t) {
        ...
        let a = (x.cssNumber[e] || (o !== 'px' && +r)) && Yn.exec(x.css(n.elem, e));
  ...
  function nr(e, t, n) {
    ...
    n.queue ||
      ...
      e.nodeType === 1 &&
        ...
        x.css(e, 'display') === 'inline' &&
          x.css(e, 'float') === 'none' &&
          (x.support.inlineBlockNeedsLayout && ln(e.nodeName) !== 'inline'
            ? (p.zoom = 1)
    ...
    if (!x.isEmptyObject(c)) {
      ...
      for (r in c)
        (a = Zn(f ? d[r] : 0, r, u)),
          r in d || ((d[r] = a.start), f && ((a.end = a.start), (a.start = r === 'width' || r === 'height' ? 1 : 0)));
    }
  }
    ...
    (rr.propHooks = {
      _default: {
        ...
        set(e) {
          x.fx.step[e.prop]
            ? x.fx.step[e.prop](e)
            : e.elem.style && (e.elem.style[x.cssProps[e.prop]] != null || x.cssHooks[e.prop])
  ...
  function ir(e, t) {
    ...
    let i = 0;
    for (t = t ? 1 : 0; i < 4; i += 2 - t) (n = Zt[i]), (r[`margin${n}`] = r[`padding${n}`] = e);
  ...
  x.each(
    ...
    x.expr &&
      ...
      (x.expr.filters.animated = function(e) {
        return x.grep(x.timers, t => e === t.elem).length;
      }),
    ...
    (x.offset = {
      setOffset(e, t, n) {
        ...
        const l = (r === 'absolute' || r === 'fixed') && x.inArray('auto', [a, s]) > -1;
        ...
        l ? ((c = i.position()), (p = c.top), (f = c.left)) : ((p = parseFloat(a) || 0), (f = parseFloat(s) || 0)),
          ...
          t.top != null && (u.top = t.top - o.top + p),
          t.left != null && (u.left = t.left - o.left + f),
    ...
    x.fn.extend({
      ...
      offsetParent() {
        return this.map(function() {
          ...
          while (e && !x.nodeName(e, 'html') && x.css(e, 'position') === 'static') e = e.offsetParent;
          return e || s;
        });
      }
    }),
    x.each({ scrollLeft: 'pageXOffset', scrollTop: 'pageYOffset' }, (e, n) => {
      const r = /Y/.test(n);
      x.fn[e] = function(i) {
        return x.access(
          this,
  ...
  x.each({ Height: 'height', Width: 'width' }, (e, n) => {
    x.each({ padding: `inner${e}`, content: n, '': `outer${e}` }, (r, i) => {
      x.fn[i] = function(i, o) {
        const a = arguments.length && (r || typeof i !== 'boolean');
    ...
    typeof module === 'object' && module && typeof module.exports === 'object'
      ? (module.exports = x)
      : ((e.jQuery = e.$ = x), typeof define === 'function' && define.amd && define('jquery', [], () => x));
})(window);
