...
!(function(e, t) {
  ...
  (w.fn = w.prototype = {
    ...
    w.each('Boolean Number String Function Array Date RegExp Object Error Symbol'.split(' '), (e, t) => {
  ...
  const E = (function(e) {
    ...
    let B = new RegExp(`^${M}+|((?:^|[^\\\\])(?:\\\\.)*)${M}+$`, 'g');

    let F = new RegExp(`^${M}*,${M}*`);

    let _ = new RegExp(`^${M}*([>+~]|${M})${M}*`);

    let z = new RegExp(`=${M}*([^\\]'"]*?)${M}*\\]`, 'g');
    ...
    let te = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g;
    ...
    let ie = me(e => !0 === e.disabled && ('form' in e || 'label' in e), { dir: 'parentNode', next: 'legend' });
    try {
    ...
    function ce(e, t) {
      ...
      let r = n && e.nodeType === 1 && t.nodeType === 1 && e.sourceIndex - t.sourceIndex;
      if (r) return r;
      ...
      (p = oe.setDocument = function(e) {
        ...
        return a !== d && a.nodeType === 9 && a.documentElement
          ? ((d = a),
            ...
            (n.getElementsByTagName = ue(e => e.appendChild(d.createComment('')), !e.getElementsByTagName('*').length)),
            (n.getElementsByClassName = Q.test(d.getElementsByClassName)),
            (n.getById = ue(e => (h.appendChild(e).id = b), !d.getElementsByName || !d.getElementsByName(b).length)),
            n.getById
...
let s = t === 'of-type';
          ...
          PSEUDO(e, t) {
            ...
            var i = r.pseudos[e] || r.setFilters[e.toLowerCase()] || oe.error(`unsupported pseudo: ${e}`);
            return i[b]
              ? i(t)
              : i.length > 1
                ? ((n = [e, e, '', t]),
    ...
    function Te(e, t, n, r, i, o) {
      return (
        ...
        se((o, a, s, u) => {
          ...
          var g = o || be(t || '*', s.nodeType ? [s] : s, []);

          var y = !e || (!o && t) ? g : we(g, p, e, s, u);

          var v = n ? (i || (o ? e : h || r) ? [] : a) : y;
          if ((n && n(y, v, s, u), r)) {
...
var s = t[5];
  ...
  function te(e) {
    return (
      e === 'true' || (e !== 'false' && (e === 'null' ? null : e === `${+e}` ? +e : Z.test(e) ? JSON.parse(e) : e))
    );
  }
  function ne(e, t, n) {
    let r;
  ...
  let he = /^$|^module$|\/(?:java|ecma)script/i;
...
var o = e.handleObj;
  ...
  function Re(e, t, n, r) {
    ...
    if (
      p &&
      ((i = xe(t, e[0].ownerDocument, !1, e, r)), (o = i.firstChild), i.childNodes.length === 1 && (i = o), o || r)
    ) {
  ...
  let Ve = { letterSpacing: '0', fontWeight: '400' };

  let Ge = ['Webkit', 'Moz', 'ms'];
...
var a = 'border-box' === w.css(e, 'boxSizing', !1, o);
...
var i = J.access(r, t) - 1;
  ...
  let Nt = /^(?:submit|button|image|reset|file)$/i;
  ...
  let Pt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/;
...
var s = t.xhr();
  ...
  w.ajaxSetup({
    ...
    w.each(['ajaxStart', 'ajaxStop', 'ajaxComplete', 'ajaxError', 'ajaxSuccess', 'ajaxSend'], (e, t) => {
      w.fn[t] = function(e) {
        return this.on(t, e);
      };
    }),
