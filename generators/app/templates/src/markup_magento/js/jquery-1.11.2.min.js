...
!(function(a, b) {
  ...
  const s = (function(a) {
      ...
      (m = gb.setDocument = function(a) {
        ...
        return g !== n && g.nodeType === 9 && g.documentElement
          ? ((n = g),
            ...
            (p = !f(g)),
            (c.attributes = jb(a => (a.className = 'i'), !a.getAttribute('className'))),
            (c.getElementsByTagName = jb(a => a.appendChild(g.createComment('')), !a.getElementsByTagName('*').length)),
            (c.getElementsByClassName = $.test(g.getElementsByClassName)),
            (c.getById = jb(a => (o.appendChild(a).id = u), !g.getElementsByName || !g.getElementsByName(u).length)),
            c.getById
      ...
      (d = gb.selectors = {
        ...
        filter: {
          ...
          PSEUDO(a, b) {
            ...
            const e = d.pseudos[a] || d.setFilters[a.toLowerCase()] || gb.error(`unsupported pseudo: ${a}`);
            return e[u]
              ? e(b)
              : e.length > 1
                ? ((c = [a, a, '', b]),
    ...
    return (
      ...
      m(),
      (c.sortDetached = jb(a => 1 & a.compareDocumentPosition(n.createElement('div')))),
      jb(a => (a.innerHTML = "<a href='#'></a>"), a.firstChild.getAttribute('href') === '#') ||
        kb('type|href|height|width', (a, b, c) => (c ? void 0 : a.getAttribute(b, b.toLowerCase() === 'type' ? 1 : 2))),
      (c.attributes &&
        jb(
          a => (
            (a.innerHTML = '<input/>'),
        ...
        kb('value', (a, b, c) => (c || a.nodeName.toLowerCase() !== 'input' ? void 0 : a.defaultValue)),
  ...
  m.extend({
    dir(a, b, c) {
      ...
      let e = a[b];
      while (e && e.nodeType !== 9 && (void 0 === c || e.nodeType !== 1 || !m(e).is(c)))
      ...
      data(a, b) {
        ...
        if (void 0 === a) {
          if (this.length && ((e = m.data(f)), f.nodeType === 1 && !m._data(f, 'parsedAttrs'))) {
            c = g.length;
            while (c--)
              g[c] && ((d = g[c].name), d.indexOf('data-') === 0 && ((d = m.camelCase(d.slice(5))), O(f, d, e[d])));
  ...
  (m.event = {
    ...
    k.changeBubbles ||
      (m.event.special.change = {
        ...
        handle(a) {
          const b = a.target;
          return this !== b || a.isSimulated || a.isTrigger || (b.type !== 'radio' && b.type !== 'checkbox')
    ...
    m.fn.extend({
      on(a, b, c, d, e) {
        ...
        if (
          (c == null && d == null
            ? ((d = b), (c = b = void 0))
            : d == null && (typeof b === 'string' ? ((d = c), (c = void 0)) : ((d = c), (c = b), (b = void 0))),
          d === !1)
        )
          d = bb;
  ...
  m.extend({
    clone(a, b, c) {
      ...
      if (
        ...
        !((k.noCloneEvent && k.noCloneChecked) || (a.nodeType !== 1 && a.nodeType !== 11) || m.isXMLDoc(a)))
      )
        for (d = ub(f), h = ub(a), g = 0; (e = h[g]) != null; ++g) d[g] && Bb(e, d[g]);
      if (b)
        if (c) for (h = h || ub(a), d = d || ub(f), g = 0; (e = h[g]) != null; g++) Ab(e, d[g]);
        else Ab(a, f);
        ...
        if (((f = a[q]), f || f === 0))
          if (m.type(f) === 'object') m.merge(p, f.nodeType ? [f] : f);
            ...
            if ((!k.leadingWhitespace && hb.test(f) && p.push(b.createTextNode(hb.exec(f)[0])), !k.tbody)) {
              (f = i !== 'table' || kb.test(f) ? (l[1] !== '<table>' || kb.test(f) ? 0 : h) : h.firstChild),
      ...
      html(a) {
        return V(
          ...
          function(a) {
            ...
            const d = this.length;
            if (void 0 === a) return b.nodeType === 1 ? b.innerHTML.replace(fb, '') : void 0;
            if (
              !(
                typeof a !== 'string' ||
                mb.test(a) ||
      ...
      function i() {
        ...
        (c = y.getElementsByTagName('body')[0]),
          c &&
            ...
            g && ((i[0].style.display = ''), (i[1].style.display = 'none'), (g = i[0].offsetHeight === 0)),
            c.removeChild(d));
      }
    }
  })(),
      ...
      (d = a[g]),
        d.style &&
          ...
          b
            ...
            : ((e = U(d)), ((c && c !== 'none') || !e) && m._data(d, 'olddisplay', e ? c : m.css(d, 'display'))));
    for (g = 0; h > g; g++)
      (d = a[g]),
        d.style &&
          ((b && d.style.display !== 'none' && d.style.display !== '') || (d.style.display = b ? f[g] || '' : 'none'));
    return a;
  }
  function Wb(a, b, c) {
    const d = Pb.exec(b);
    ...
    for (var f = c === (d ? 'border' : 'content') ? 4 : b === 'width' ? 1 : 0, g = 0; f < 4; f += 2)
      c === 'margin' && (g += m.css(a, c + T[f], !0, e)),
        d
          ...
          : ((g += m.css(a, `padding${T[f]}`, !0, e)), c !== 'padding' && (g += m.css(a, `border${T[f]}Width`, !0, e)));
    return g;
  }
  function Yb(a, b, c) {
    let d = !0;
    ...
    if (e <= 0 || e == null) {
      if (((e = Jb(a, b, f)), (e < 0 || e == null) && (e = a.style[b]), Hb.test(e))) return e;
  ...
  m.extend({
    ...
    style(a, b, c, d) {
      if (a && a.nodeType !== 3 && a.nodeType !== 8 && a.style) {
        ...
        if (
          ((f = typeof c),
          f === 'string' && (e = Qb.exec(c)) && ((c = (e[1] + 1) * e[2] + parseFloat(m.css(a, b))), (f = 'number')),
          c != null &&
            c === c &&
    ...
    (m.cssHooks.marginRight = Lb(
      ...
      (a, b) => (b ? m.swap(a, { display: 'inline-block' }, Jb, [a, 'marginRight']) : void 0)
    )),
  ...
  function ic(a, b, c) {
    ...
    c.queue ||
      ...
      a.nodeType === 1 &&
        ...
        l === 'inline' &&
          m.css(a, 'float') === 'none' &&
          (k.inlineBlockNeedsLayout && Fb(a.nodeName) !== 'inline' ? (p.zoom = 1) : (p.display = 'inline-block'))),
      c.overflow &&
        ((p.overflow = 'hidden'),
        k.shrinkWrapBlocks() ||
          n.always(() => {
    ...
    if (m.isEmptyObject(o)) (j === 'none' ? Fb(a.nodeName) : j) === 'inline' && (p.display = j);
      ...
      for (d in o)
        (g = hc(q ? r[d] : 0, d, n)),
          d in r || ((r[d] = g.start), q && ((g.end = g.start), (g.start = d === 'width' || d === 'height' ? 1 : 0)));
    }
  }
  function jc(a, b) {
    let c;
            ...
            this.each(function(c) {
              ...
              this.nodeType === 1 &&
                ...
                e == null
                  ...
                  : typeof e === 'number'
                    ? (e += '')
                    : m.isArray(e) && (e = m.map(e, a => (a == null ? '' : `${a}`))),
        ...
        if (e)
          return (
            ...
            b && 'get' in b && void 0 !== (c = b.get(e, 'value'))
              ? c
              : ((c = e.value), typeof c === 'string' ? c.replace(lc, '') : c == null ? '' : c)
          );
      }
    }
  }),
  ...
  m.fn.extend({
    ...
    hasClass(a) {
      for (let b = ` ${a} `, c = 0, d = this.length; d > c; c++)
        if (this[c].nodeType === 1 && ` ${this[c].className} `.replace(uc, ' ').indexOf(b) >= 0) return !0;
      return !1;
    }
  }),
    m.each(
  ...
  (m.parseJSON = function(b) {
    ...
    const e = m.trim(`${b}`);
    return e &&
      !m.trim(e.replace(xc, (a, b, e, f) => c && b && (d = 0), d === 0 ? a : ((c = e || b), (d += !f - !e), '')))
      ? Function(`return ${e}`)()
  ...
  m.extend({
      ...
      if (
        ...
        k.crossDomain == null &&
          ...
          (k.crossDomain = !(
            ...
            (c[1] === yc[1] &&
              c[2] === yc[2] &&
              (c[3] || (c[1] === 'http:' ? '80' : '443')) === (yc[3] || (yc[1] === 'http:' ? '80' : '443')))
          ))),
        k.data && k.processData && typeof k.data !== 'string' && (k.data = m.param(k.data, k.traditional)),
        Mc(Hc, k, b, v),
        t === 2)
      )
        return v;
    ...
    (m.expr.filters.hidden = function(a) {
      return (
        ...
        (!k.reliableHiddenOffsets() && ((a.style && a.style.display) || m.css(a, 'display')) === 'none')
      );
    }),
        ...
        return this.map(function() {
          ...
          .map(function(a, b) {
            ...
            return c == null
              ? null
              : m.isArray(c)
                ? m.map(c, a => ({ name: b.name, value: a.replace(Sc, '\r\n') }))
  ...
  (m.offset = {
    ...
    m.each(['top', 'left'], (a, b) => {
      m.cssHooks[b] = Lb(
        k.pixelPosition,
        (a, c) => (c ? ((c = Jb(a, b)), Hb.test(c) ? `${m(a).position()[b]}px` : c) : void 0)
      );
    }),
